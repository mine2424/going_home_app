...
import 'package:going_home_app/common/packages/cool_dropdown/drop_down_body.dart';
import 'package:going_home_app/common/packages/cool_dropdown/utils/animation_util.dart';
import 'package:going_home_app/common/packages/cool_dropdown/utils/extension_util.dart';
...
class CoolDropdown extends StatefulWidget {
  ...
  Function? onOpen;
  String placeholder;
  late CoolDropdownItem defaultValue;
  bool isTriangle;
  bool isAnimation;
  ...
  CoolDropdown({
    ...
    if (defaultValue != null) {
      ...
      this.defaultValue = dropdownList[0];
    }
    // label unique 체크
...
class _CoolDropdownState extends State<CoolDropdown>
  ...
  late CoolDropdownItem selectedItem;
